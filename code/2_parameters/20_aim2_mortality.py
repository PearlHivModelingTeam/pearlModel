...
df4 = pd.concat([df4.assign(group='msm_hisp_male'), df4.assign(group='msm_white_male'), df4.assign(group='msm_black_male')])
df = df.loc[df['group'] != group].copy()
