...
config_files = ['bmi_S0.yaml','bmi_S1.yaml']
for f in config_files:
    ...
    ############
    print(f"Running simulations outputs ...")
    ...
    # Specify the command to call another Python script
    command = ["python3", f"{pearl_path}/code/3_convert_csv_to_hdf.py", "--arg1", f"{output_root_path}"]
