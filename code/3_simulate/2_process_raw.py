...
for group_name in group_names:
    ...
    comorbid_zero_count = pd.DataFrame()
    comorbid_one_count = pd.DataFrame()
    comorbid_two_count = pd.DataFrame()
    comorbid_three_count = pd.DataFrame()
    comorbid_four_count = pd.DataFrame()
    ...
    for replication in range(replications):
        ...
        with pd.HDFStore(f'{h5_dir}/{group_name}_{replication}.h5') as store:
            ...
            if comorbidity:
                ...
                comorbid_zero_count = comorbid_zero_count.append(store['comorbid_zero_count'])
                comorbid_one_count = comorbid_one_count.append(store['comorbid_one_count'])
                comorbid_two_count = comorbid_two_count.append(store['comorbid_two_count'])
                comorbid_three_count = comorbid_three_count.append(store['comorbid_three_count'])
                comorbid_four_count = comorbid_four_count.append(store['comorbid_four_count'])
    ...
    if comorbidity:
        ...
        feather.write_dataframe(comorbid_zero_count, f'{feather_dir}/{group_name}_comorbid_zero_count.feather')
        feather.write_dataframe(comorbid_one_count, f'{feather_dir}/{group_name}_comorbid_one_count.feather')
        feather.write_dataframe(comorbid_two_count, f'{feather_dir}/{group_name}_comorbid_two_count.feather')
        feather.write_dataframe(comorbid_three_count, f'{feather_dir}/{group_name}_comorbid_three_count.feather')
        feather.write_dataframe(comorbid_four_count, f'{feather_dir}/{group_name}_comorbid_four_count.feather')
