...
cwd = os.getcwd()
h5_dir0 = cwd + '/../../out/sa'
feather_dir0 = cwd + '/../../out/processed/sa_5_6'
...
keys = ['lambda1', 'mu1', 'mu2', 'sigma1', 'sigma2', 'mortality_in_care', 'mortality_out_care', 'loss_to_follow_up', 'cd4_increase', 'cd4_decrease', 'new_pop_size']
params = ['0', '1']
...
for key in keys:
    ...
    for param in params:
        print(param)
        folder = f'{key}_{param}'
        h5_dir = f'{h5_dir0}/{folder}'
        feather_dir = f'{feather_dir0}/{folder}'
