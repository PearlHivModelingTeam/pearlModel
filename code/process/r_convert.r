...
save(on_art, naaccord, naaccord_prop_2009, init_sqrtcd4n_coeffs,
     coeff_age_2009_ci, new_dx, new_dx_interval, gmix_param_coeffs, 
     cd4_increase_coeff, cd4_increase_vcov, cd4_decrease_coeff, 
     cd4_decrease_vcov, mortality_out_coeff, mortality_out_vcov,
     mortality_in_coeff, mortality_in_vcov, leave_na_coeff, 
     leave_na_vcov, pctls_leave_na, file=paste0(procwd,"/sense.convert")) 
