######################################################################################
# Load packages and name directories
######################################################################################
library(binom)
library(broom)
library(gamlss)
...
data_dir <- "/home/cameron/silvertsunami/statepi/lhume/naaccord/Silver/Data"
paramwd <- paste0(data_dir, "/parameters/")
naaccordwd <- paste0(data_dir, "/naaccord/")
outwd <- paste0(getwd(),"/../../../data/processed")

######################################################################################
# Call function source file
######################################################################################
source(paste0(getwd(),"/fx.R"))
...
save.image(file=paste0(outwd,"/basic.data")) 
