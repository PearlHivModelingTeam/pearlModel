...
rule all:
    input: 
        directory("out/S0_10/combined/bmi_info.parquet"),
        directory("out/S0_10/combined/bmi_int_cascade.parquet"),
        directory("out/S0_10/combined/new_init_age.parquet"),
        directory("out/S3_10/combined/bmi_info.parquet"),
        directory("out/S3_10/combined/bmi_int_cascade.parquet"),
        directory("out/S3_10/combined/new_init_age.parquet"),
