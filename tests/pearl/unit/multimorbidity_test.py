...
def expected_ckd_result():
    return np.array([18.0, 1.0, 0.0, 0.0, -2.200000000000003, 30.6, 4.985694456247702, 1.0459082249794633, 11.038756528100167, 1.0, 1.0, 2.0, 0.0, 1.0, 1.0, 1.0, 1.0, 2002.0])
...
def expected_lipid_result():
    return np.array([18.0, 1.0, 0.0, 0.0, -2.200000000000003, 30.6, 4.869224773242633, 1.0857984339569167, 11.038756528100167, 1.0, 1.0, 1.0, 2.0, 0.0, 1.0, 1.0, 1.0, 2002.0])

def test_create_comorbidity_pop_matrix_lipid(test_parameters, test_population, expected_lipid_result):
...
def expected_dm_result():
    return np.array([18.0, 1.0, 0.0, 0.0, -2.200000000000003, 30.6, 5.309525247713419, 1.1570813643292703, 11.038756528100167, 1.0, 1.0, 2.0, 0.0, 1.0, 1.0, 1.0, 1.0, 2002.0])
...
def expected_ht_result():
    return np.array([18.0, 1.0, 0.0, 0.0, -2.200000000000003, 30.6, 6.216349417780263, 1.3954920938426507, 11.038756528100167, 1.0, 1.0, 1.0, 2.0, 0.0, 1.0, 1.0, 1.0, 2002.0])
...
def expected_other_result():
    ...
    '''
    return np.array([18.0, 1.0, 0.0, 0.0, -2.200000000000003, 30.6, 5.045609471134623, 1.0614023818440457, 11.038756528100167, 1.0, 1.0, 1.0, 2.0, 0.0, 1.0, 1.0, 1.0, 1.0, 2002.0])

def test_create_comorbidity_pop_matrix_other(test_parameters, test_population, expected_other_result):
