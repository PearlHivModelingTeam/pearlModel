...
def test_cd4_increase_pop():
    population = {
        ...
        'last_init_sqrtcd4n' : [7.785768284900243, 
                                13.921099280684002,
                                6.670803203549613,
                                3.962003815707643,
                                11.188837871609948],
...
def expected_cd4_increase():
    return np.array([13.321834633018316, 14.5111149282341, 19.867717597510353, 15.451144615518423, 18.613086718713745])
...
def test_cd4_decrease_pop():
    population = {
        ...
        'sqrtcd4n_exit' : [16.459867166915828,
                           26.136887305474033,
                           19.082228482285846,
                           23.125814322560394,
                           26.30349530000121],
...
def expected_cd4_decrease():
    return np.array([11.286071129634552, 19.81473466999056, 11.645263381341982, 16.58330381833863, 18.207905726917033])
