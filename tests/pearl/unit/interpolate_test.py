...
def test_restricted_cubic_spline_var(cubic_test_series, cubic_knots, expected_first_cubic_knot, expected_second_cubic_knot):
    '''
...
def test_restricted_quadratic_spline_var(cubic_test_series, cubic_knots, expected_first_quadratic_knot, expected_second_quadratic_knot, expected_third_quadratic_knot):
    '''
    It should return the expected value.
    '''
